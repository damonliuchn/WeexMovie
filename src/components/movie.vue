<template>
  <div class="g-flex-row padding"  @click="test2()">
    ...
    <image style="width:159px; height:231px;" v-bind:src="data.img" placeholder="http://resizing.flixster.com/Q8IBqX3b-nhEAEYokJ_aH6jO6lE=/54x78/dkpu1ddg7pbsk.cloudfront.net/movie/10/94/13/10941373_ori.jpg"></image>
  </div>
</template>
